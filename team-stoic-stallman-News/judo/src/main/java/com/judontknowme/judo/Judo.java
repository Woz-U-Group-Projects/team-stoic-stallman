...
@WebServlet("/Judo")
public class Judo extends HttpServlet {

	private static final long serialVersionUID = 1233845347034639521L;
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		// Store the 'responseText' string in the response object (to be sent to the
		// client)
