...
import { createServer as __createServer } from 'https';
...
if (satisfies(process.version, '8.6.0 - 9')) {
...
class Server {
    ...
    setupStaticFeature() {
        ...
        if (Array.isArray(contentBase)) {
            ...
            this.app.get(
                '*',
                static(contentBase, this.options.staticOptions)
            );
        }
    }
    ...
    createServer() {
        if (this.options.https) {
            ...
            if (gte(process.version, '10.0.0') || !isHttp2) {
                ...
                this.listeningApp = __createServer(this.options.https, this.app);
            } else {
                // The relevant issues are:
            ...
            this.listeningApp = _createServer(this.app);
        }
    }
