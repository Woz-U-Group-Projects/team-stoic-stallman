...
<head>
	...
	<title>Pivotal tc Server &#8212; Developer Edition</title>
	<link type="text/css" rel="stylesheet" href="splash.css">
</head>

<body>
	<div id="container">
		<!-- This page was released with Pivotal tc Server Developer Edition 4.0.4.RELEASE -->
		<!-- Header -->
		...
		<div id="content">
    		<div id="intro">
				<!--<h4>Pivotal</h4>-->
				<h2>Pivotal tc Server &#8212; Developer Edition</h2>
			...
			<div>
				...
				<ul>
					...
					<li><a href="http://www.spring.io/tools">Spring Tool Suite (STS)</a><br />Go here to download the latest STS release with Pivotal tc Server.</li>
		...
		<div id="ftr">&copy; 2018 Pivotal Software, Inc. All rights reserved.</div>
	</div>
